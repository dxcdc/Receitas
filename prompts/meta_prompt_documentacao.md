# ✍️ Meta-Prompt Mestre: Arquitetura de Informação, DevOps, Rclone, Mattermost, GitHub Issues & Governança

Este é o **Prompt Mestre Definitivo**. Ele reúne as diretrizes de **Arquitetura de Informação, Redação Técnica (Modelo Híbrido), Governança DevOps, Backup 3-2-1 com Rclone & Google Drive, Alertas no Mattermost, Automação de GitHub Issues via GitHub Actions e a criação dos 8 arquivos de documentação padrão**.
